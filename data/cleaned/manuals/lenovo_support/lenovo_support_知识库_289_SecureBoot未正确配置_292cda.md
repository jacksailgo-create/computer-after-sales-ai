...
url: https://iknow.lenovo.com.cn//knowledgeapi/api/knowledge/knowledgeDetails?knowledgeNo=289
category: manuals
---
...
**请执行以下步骤：步骤1：**在机器重启至"**Lenovo字样的屏幕**”时，不停敲击"**F2**”键或"**Fn+F2**”键进入BIOS。选择"**Security**”选项，选择"**Reset to Setup Mode**”并敲回车，选择"**YES**”并按下"**回车**”键。
...
<!-- 文档主题: SecureBoot未正确配置 （知识库编号: 289） -->